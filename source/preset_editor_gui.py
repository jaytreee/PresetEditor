...
"")
        ...
        self.nameBox.setGeometry(QtCore.QRect(160, 60, 161, 31))
        self.nameBox.setObjectName("nameBox")
        self.detectorBox = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.detectorBox.setGeometry(QtCore.QRect(160, 120, 161, 31))
        self.detectorBox.setObjectName("detectorBox")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(50, 170, 511, 331))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
